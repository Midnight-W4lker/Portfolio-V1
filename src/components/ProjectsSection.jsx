...
const ProjectsSection = ({
  ...
  projects = [
    {
      ...
      techStack: ["React", "Node.js", "MongoDB", "Dash"],
  ...
  const getTechStackColor = (tech) => {
    const colors = {
      ...
      'Pandas': 'bg-blue-700/20 text-blue-400 border-blue-700/30',
      'Scikit-learn': 'bg-green-500/20 text-green-300 border-green-500/30',
      'Flask': 'bg-orange-500/20 text-orange-300 border-orange-500/30',
      'Dash': 'bg-purple-500/20 text-purple-300 border-purple-500/30',
      'SQL-Lite': 'bg-cyan-600/20 text-blue-400 border-gray-600/30',
      ...
      'Git': 'bg-gray-700/20 text-gray-500 border-gray -700/30',
